  ...
  data() {
    return {
      ...
      dataProject: [
          ...
          {
              id: 9,
              nama: 'Occupational Oversight of Islamic Development Center',
              year: '2010-2011',
          ...
          {
              id: 26,
              nama: 'Construction Management for the Construction of Simple Flats for Construction in 26 Locations spread across Sumatra, Java, Kalimantan and Sulawesi (5 floors)',
              year: '2007-2008',
              cat: 'Construction Management',
              img: '/project-26.jpg',
          },
          {
              id: 27,
              nama: 'Construction Management (MK) Construction of Simple Flats (Rusunawa) and PSD for Marunda Location in DKI Jakarta (6th Floor 3 Blocks)',
              year: '2004-2006',
              cat: 'Construction Management',
              img: '/project-27.jpg',
          },
          {
              id: 28,
              nama: 'Construction Management for Construction of the JFA Puskin Building Puslitbang, Pusinfowas, Representative of BPKP DKI II and Inspectorate',
              year: '2003-2007',
              cat: 'Construction Management',
              img: '/project-28.jpg',
          },
          {
              id: 29,
              nama: 'Continued Work on Renovation of Blok G Building as a Green Building',
              year: '2011',
              cat: 'Construction Management',
              img: '/project-29.jpg',
          },
          {
              id: 30,
              nama: 'Supervision of the Completion of Marunda Cluster B Block I and II Settlement Construction',
              year: '2009',
              cat: 'Construction Management',
              img: '/project-30.jpg',
          },
          {
              id: 31,
              nama: 'Supervision of the Construction of Regional Office Building of the Regional Office of DPJ in South Sumatra and the Bangka Belitung Islands and the Tax Service Office',
              year: '2007-2008',
              cat: 'Construction Management',
              img: '/project-31.jpg',
          },
          {
              id: 32,
              nama: 'Supervision (Phase I to Stage III) Construction of the DKI Jakarta Provincial Archives Building',
              year: '2004-2006',
              cat: 'Construction Management',
              img: '/project-32.jpg',
          },
          {
              id: 33,
              nama: 'Supervision (Phase I to Stage III) Development of Budhi Asih Hospital Building Jakarta',
              year: '2003-2005',
              cat: 'Construction Management',
              img: '/project-33.jpg',
          },
          {
              id: 34,
              nama: 'Supervision of Exterior Renovations of Sarinah Building Jakarta',
              year: '2004-2005',
              cat: 'Construction Management',
              img: '/project-34.jpg',
          },
          ...
          {
              id: 38,
              nama: "Supervision of the Construction of Block C and D Buildings in East Jakarta Mayor's Office",
              year: '2007-2009',
              cat: 'Supervision Consultant',
              img: '/project-38.jpg',
          },
          ...
          {
              id: 40,
              nama: "Inspect and reviewing structure of Arcadia Apartment and Office Buildings (4 Tower).",
              year: '2008',
              cat: 'Building Audit',
              img: '/project-40.jpg',
          },
