  ...
  data() {
    return {
      ...
      dataProject: [
          ...
          {
              id: 42,
              nama: 'Building Process Renovation Advanced Stage, Archives, Telematics, Supporting, Main PPPTMGB "LEMIGAS"',
              year: '2007',
              cat: 'Detail Engineering Design',
              img: '/project-42.jpg',
          },
          ...
          {
              id: 45,
              nama: 'The Construction and Equipment of Two Orphan Centers in Aceh Province, Indonesia (Ind 103a-SCC 0001)',
              year: '2006',
              cat: 'Detail Engineering Design',
              img: '/project-45.jpg',
          },
          ...
          },
          {
              ...
              year: '2015-2016',
              cat: 'Architecture Design, Structure Design, Mechanical, Electrical and Plumbing Design',
              img: '/project-58.jpg',
          },
          {
              id: 59,
          ...
          {
              id: 65,
              nama: 'Office Building for the Republic of Indonesia State Code Agency',
              year: '2007',
              cat: 'Architecture Design, Structure Design, Mechanical, Electrical and Plumbing Design',
              img: '/project-65.jpg',
          },
